    ...
    <Container className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <Expand title="A consent form">
          The consent form is a document that tells you what an activity is about, what might happen during it, and if there are any possible problems. It lets you choose if you want to take part or not. This form makes sure that your rights are protected, and anything you share will be kept private. It's all about making sure you understand and agree with what's going to happen.
        </Expand>
